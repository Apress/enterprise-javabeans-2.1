...
import ejb.counterBmp.*;
import ejb.test.*;
import javax.ejb.*;

public class TestCounterBmpBean extends EJBTestCase {
    ...
    public void prepareTest()
        throws Exception
    {
        counterHome = (CounterHome)narrow("CounterBmp", CounterHome.class);
    }
        ...
        throws Exception
    {
        ...
        java.util.Collection col = counterHome.findAllCounters();
